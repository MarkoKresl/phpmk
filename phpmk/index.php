...
<html>
	<head>
        ...
        <meta name="author" content="mkresl@vvg.hr">
		<!-- favicon meta -->
...
<body>
	...
	<footer style="background-color: #333;">
		<p>Copyright &copy; ' . date("Y") . ' Marko Kresl <a href="https://github.com/MarkoKresl?tab=repositories"><title="Github" alt="Github"></a></p>
	</footer>
</body>
</html>';
?>