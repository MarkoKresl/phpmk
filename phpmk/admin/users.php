...
# Example of setting the session variable for demonstration purposes
if (!isset($_SESSION['user'])) {
    $_SESSION['user'] = ['role' => 1]; // Set a default role for testing
}
...
# Edit user profile
    ...
    if (isset($_SESSION['user']['role']) && ($_SESSION['user']['role'] == 1 || $_SESSION['user']['role'] == 2)) {
        ...
        <form action="" id="registration_form" name="registration_form" method="POST">
            ...
            <input type="radio" name="archive" value="Y"'; if ($row['archive'] == 'Y') {
                echo ' checked="checked"';
                $checked_archive = true;
            } echo ' /> YES &nbsp;&nbsp;
            <input type="radio" name="archive" value="N"'; if ($checked_archive == false) {
                echo ' checked="checked"';
            } echo ' /> NO
        ...
        <table>
            ...
            while ($row = @mysqli_fetch_array($result)) {
                ...
                <tr>
                    ...
                    <td>';
                        if (isset($_SESSION['user']['role']) && ($_SESSION['user']['role'] == 1 || $_SESSION['user']['role'] == 2)) {
                            print '<a href="index.php?menu=' . $menu . '&amp;action=' . $action . '&amp;edit=' . $row['id'] . '"><img src="img/edit.png" alt="edit"></a></td>';
                        }
                    print '
                    <td>';
                        if (isset($_SESSION['user']['role']) && ($_SESSION['user']['role'] == 1 || $_SESSION['user']['role'] == 2)) {
                            print '<a href="index.php?menu=' . $menu . '&amp;action=' . $action . '&amp;delete=' . $row['id'] . '"><img src="img/delete.png" alt="delete"></a>';
                        }
                    print '    
                    </td>
